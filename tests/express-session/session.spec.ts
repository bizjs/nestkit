...
describe('session()', function () {
  ...
  it('should do nothing if req.session exists', function (_context, done) {
  ...
  it('should error without secret', function (_context, done) {
    request(createServer({ secret: undefined }))
      .get('/')
      .expect(500, /secret.*required/, done);
  });

  it('should require explicit secret even with req.secret', function (_context, done) {
    function setup(req: TestRequest) {
  ...
  it('should create a new session', function (_context, done) {
  ...
  it('should load session from cookie sid', function (_context, done) {
    let count = 0;
  ...
  it('should pass session fetch error', function (_context, done) {
    let store = new session.MemoryStore();
    let server: http.Server = createServer({ store: store }, function (req: TestRequest, res: TestResponse) {
      res.end('hello, world');
    });
  ...
  it('should treat ENOENT session fetch error as not found', function (_context, done) {
    let count = 0;
    let store = new session.MemoryStore();
    let server: http.Server = createServer({ store: store }, function (req: TestRequest, res: TestResponse) {
      req.session.num = req.session.num || ++count;
  ...
  it('should handle empty req.url', function (_context, done) {
    function setup(req: TestRequest) {
      req.url = '';
    }
  ...
  it('should handle multiple res.end calls', function (_context, done) {
    let server: http.Server = createServer(null, function (req: TestRequest, res: TestResponse) {
  ...
  it('should handle res.end(null) calls', function (_context, done) {
    let server: http.Server = createServer(null, function (req: TestRequest, res: TestResponse) {
      res.end(null);
    });
  ...
  it('should handle reserved properties in storage', function (_context, done) {
    let count = 0;
    let sid;
    let store = new session.MemoryStore();
    let server: http.Server = createServer({ store: store }, function (req: TestRequest, res: TestResponse) {
  ...
  it('should only have session data enumerable (and cookie)', function (_context, done) {
    let server: http.Server = createServer(null, function (req: TestRequest, res: TestResponse) {
      req.session.test1 = 1;
      req.session.test2 = 'b';
  ...
  it('should not save with bogus req.sessionID', function (_context, done) {
    let store = new session.MemoryStore();
    let server: http.Server = createServer({ store: store }, function (req: TestRequest, res: TestResponse) {
  ...
  it('should update cookie expiration when slow write', function (_context, done) {
  ...
  describe('when response ended', function () {
    it('should have saved session', function (_context, done) {
      let store = new session.MemoryStore();
      let server: http.Server = createServer({ store: store }, function (req: TestRequest, res: TestResponse) {
    ...
    it('should have saved session even with empty response', function (_context, done) {
      let store = new session.MemoryStore();
      let server: http.Server = createServer({ store: store }, function (req: TestRequest, res: TestResponse) {
        req.session.hit = true;
    ...
    it('should have saved session even with multi-write', function (_context, done) {
      let store = new session.MemoryStore();
      let server: http.Server = createServer({ store: store }, function (req: TestRequest, res: TestResponse) {
        req.session.hit = true;
    ...
    it('should have saved session even with non-chunked response', function (_context, done) {
      let store = new session.MemoryStore();
      let server: http.Server = createServer({ store: store }, function (req: TestRequest, res: TestResponse) {
        req.session.hit = true;
    ...
    it('should have saved session with updated cookie expiration', function (_context, done) {
      let store = new session.MemoryStore();
  ...
  describe('when sid not in store', function () {
    ...
    it('should have a new sid', function (_context, done) {
      let count = 0;
      let store = new session.MemoryStore();
      let server: http.Server = createServer({ store: store }, function (req: TestRequest, res: TestResponse) {
        req.session.num = req.session.num || ++count;
  ...
  describe('when sid not properly signed', function () {
    it('should generate new session', function (_context, done) {
      let store = new session.MemoryStore();
      let server: http.Server = createServer(
    ...
    it('should not attempt fetch from store', function (_context, done) {
      let store = new session.MemoryStore();
      let server: http.Server = createServer(
        { store: store, key: 'sessid' },
        function (req: TestRequest, res: TestResponse) {
  ...
  describe('when session expired in store', function () {
    ...
    it('should not exist in store', function (_context, done) {
      let count = 0;
      let store = new session.MemoryStore();
      let server: http.Server = createServer(
        { store: store, cookie: { maxAge: 5 } },
  ...
  describe('when session without cookie property in store', function () {
    it('should pass error from inflate', function (_context, done) {
      let count = 0;
      let store = new session.MemoryStore();
      let server: http.Server = createServer({ store: store }, function (req: TestRequest, res: TestResponse) {
        req.session.num = req.session.num || ++count;
  ...
  describe('proxy option', function () {
    describe('when enabled', function () {
      ...
      it('should trust X-Forwarded-Proto when string', function (_context, done) {
        request(server)
          .get('/')
      ...
      it('should trust X-Forwarded-Proto when comma-separated list', function (_context, done) {
        request(server)
          .get('/')
      ...
      it('should work when no header', function (_context, done) {
    ...
    describe('when disabled', function () {
      ...
      it('should not trust X-Forwarded-Proto', function (_context, done) {
      ...
      it('should ignore req.secure', function (_context, done) {
        request(suiteState.server)
          .get('/')
          .set('X-Forwarded-Proto', 'https')
          .set('X-Secure', 'true')
    ...
    describe('when unspecified', function () {
      ...
      it('should use req.secure', function (_context, done) {
        request(suiteState.server)
          .get('/')
          .set('X-Forwarded-Proto', 'https')
          .set('X-Secure', 'true')
  ...
  describe('cookie option', function () {
    describe('when "path" set to "/foo/bar"', function () {
      ...
      it('should not set cookie for "/" request', function (_context, done) {
        request(suiteState.server).get('/').expect(shouldNotHaveHeader('Set-Cookie')).expect(200, done);
      });

      it('should not set cookie for "http://foo/bar" request', function (_context, done) {
        request(suiteState.server)
          .get('/')
      ...
      it('should set cookie for "/foo/bar" request', function (_context, done) {
        request(suiteState.server).get('/foo/bar/baz').expect(shouldSetCookie('connect.sid')).expect(200, done);
      });

      it('should set cookie for "/foo/bar/baz" request', function (_context, done) {
        request(suiteState.server).get('/foo/bar/baz').expect(shouldSetCookie('connect.sid')).expect(200, done);
      });
      ...
      describe('when mounted at "/foo"', function () {
        ...
        it('should not set cookie for "/foo/foo/bar" request', function (_context, done) {
    ...
    describe('when "secure" set to "auto"', function () {
      describe('when "proxy" is "true"', function () {
        ...
        it('should set secure when X-Forwarded-Proto is https', function (_context, done) {
          request(suiteState.server)
            .get('/')
            .set('X-Forwarded-Proto', 'https')
      ...
      describe('when "proxy" is "false"', function () {
        ...
        it('should not set secure when X-Forwarded-Proto is https', function (_context, done) {
          request(suiteState.server)
            .get('/')
            .set('X-Forwarded-Proto', 'https')
      ...
      describe('when "proxy" is undefined', function () {
        ...
        it('should set secure if req.secure = true', function (_context, done) {
          request(suiteState.server)
            .get('/')
            .set('X-Secure', 'true')
            .expect(shouldSetCookieWithAttribute('connect.sid', 'Secure'))
        ...
        it('should not set secure if req.secure = false', function (_context, done) {
          request(suiteState.server)
            .get('/')
            .set('X-Secure', 'false')
            .expect(shouldSetCookieWithoutAttribute('connect.sid', 'Secure'))
    ...
    describe('when "cookie" is a function', function () {
      it('should call custom function and apply cookie options', function (_context, done) {
      ...
      it('should provide req argument', function (_context, done) {
        let _path = '/test';
        let cookieCallbackCalled = false;
    ...
    describe('when "sameSite" set to "auto"', function () {
      describe('basic functionality', function () {
        ...
        it('should set SameSite=None for secure connections', function (_context, done) {
          request(suiteState.server)
            .get('/')
            .set('X-Secure', 'true')
        ...
        it('should set SameSite=Lax for insecure connections', function (_context, done) {
          request(suiteState.server)
            .get('/')
            .set('X-Secure', 'false')
      ...
      describe('with proxy settings', function () {
        describe('when "proxy" is "true"', function () {
          ...
          it('should set SameSite=None when X-Forwarded-Proto is https', function (_context, done) {
            request(suiteState.server)
              .get('/')
              .set('X-Forwarded-Proto', 'https')
              .expect(shouldSetCookieWithAttributeAndValue('connect.sid', 'SameSite', 'None'))
          ...
          it('should set SameSite=Lax when X-Forwarded-Proto is http', function (_context, done) {
            request(suiteState.server)
              .get('/')
        ...
        describe('when "proxy" is "false"', function () {
          ...
          it('should set SameSite=Lax when X-Forwarded-Proto is https', function (_context, done) {
            request(suiteState.server)
              .get('/')
              .set('X-Forwarded-Proto', 'https')
              .expect(shouldSetCookieWithAttributeAndValue('connect.sid', 'SameSite', 'Lax'))
      ...
      describe('combined with secure auto', function () {
        describe('when "secure" is "auto"', function () {
          ...
          it('should set both Secure and SameSite=None when secure', function (_context, done) {
            request(suiteState.server)
              .get('/')
              .set('X-Secure', 'true')
              .expect(shouldSetCookieWithAttribute('connect.sid', 'Secure'))
          ...
          it('should set neither Secure nor SameSite=None when insecure', function (_context, done) {
            request(suiteState.server)
              .get('/')
              .set('X-Secure', 'false')
              .expect(shouldSetCookieWithoutAttribute('connect.sid', 'Secure'))
        ...
        describe('when "secure" is "false"', function () {
          ...
          it('should set SameSite=None without Secure when secure', function (_context, done) {
            request(suiteState.server)
              .get('/')
              .set('X-Secure', 'true')
              .expect(shouldSetCookieWithoutAttribute('connect.sid', 'Secure'))
          ...
          it('should set SameSite=Lax without Secure when insecure', function (_context, done) {
            request(suiteState.server)
              .get('/')
              .set('X-Secure', 'false')
              .expect(shouldSetCookieWithoutAttribute('connect.sid', 'Secure'))
        ...
        describe('when "secure" is "true"', function () {
          ...
          it('should not set cookie when insecure', function (_context, done) {
            request(suiteState.server)
              .get('/')
              .set('X-Secure', 'false')
              .expect(shouldNotHaveHeader('Set-Cookie'))
  ...
  describe('genid option', function () {
    ...
    it('should provide default generator', function (_context, done) {
      request(createServer()).get('/').expect(shouldSetCookie('connect.sid')).expect(200, done);
    });

    it('should allow custom function', function (_context, done) {
      function genid() {
        return 'apple';
      }
    ...
    it('should encode unsafe chars', function (_context, done) {
      function genid() {
        return '%';
      }
  ...
  describe('key option', function () {
    it('should default to "connect.sid"', function (_context, done) {
      request(createServer()).get('/').expect(shouldSetCookie('connect.sid')).expect(200, done);
    });

    it('should allow overriding', function (_context, done) {
  ...
  describe('name option', function () {
    ...
    it('should set the cookie name', function (_context, done) {
  ...
  describe('rolling option', function () {
    it('should default to false', function (_context, done) {
      let server: http.Server = createServer(null, function (req: TestRequest, res: TestResponse) {
        req.session.user = 'bob';
        res.end();
      });
    ...
    it('should force cookie on unmodified session', function (_context, done) {
      let server: http.Server = createServer({ rolling: true }, function (req: TestRequest, res: TestResponse) {
        req.session.user = 'bob';
        res.end();
      });
    ...
    it('should not force cookie on uninitialized session if saveUninitialized option is set to false', function (_context, done) {
      let store = new session.MemoryStore();
      let server: http.Server = createServer({
        store: store,
        rolling: true,
    ...
    it('should force cookie and save uninitialized session if saveUninitialized option is set to true', function (_context, done) {
      let store = new session.MemoryStore();
      let server: http.Server = createServer({
        store: store,
        rolling: true,
    ...
    it('should force cookie and save modified session even if saveUninitialized option is set to false', function (_context, done) {
      let store = new session.MemoryStore();
      let server: http.Server = createServer(
  ...
  describe('resave option', function () {
    it('should default to true', function (_context, done) {
      let store = new session.MemoryStore();
      let server: http.Server = createServer({ store: store }, function (req: TestRequest, res: TestResponse) {
        req.session.user = 'bob';
        res.end();
    ...
    describe('when true', function () {
      it('should force save on unmodified session', function (_context, done) {
        let store = new session.MemoryStore();
        let server: http.Server = createServer(
    ...
    describe('when false', function () {
      it('should prevent save on unmodified session', function (_context, done) {
        let store = new session.MemoryStore();
        let server: http.Server = createServer(
      ...
      it('should still save modified session', function (_context, done) {
        let store = new session.MemoryStore();
        let server: http.Server = createServer(
      ...
      it('should detect a "cookie" property as modified', function (_context, done) {
        let store = new session.MemoryStore();
        let server: http.Server = createServer(
          { store: store, resave: false },
          function (req: TestRequest, res: TestResponse) {
  ...
  describe('saveUninitialized option', function () {
    ...
    it('should force save of uninitialized session', function (_context, done) {
      let store = new session.MemoryStore();
      let server: http.Server = createServer({
        store: store,
        saveUninitialized: true,
    ...
    it('should prevent save of uninitialized session', function (_context, done) {
      let store = new session.MemoryStore();
      let server: http.Server = createServer({
        store: store,
        saveUninitialized: false,
  ...
  describe('secret option', function () {
    ...
    it('should sign and unsign with a string', function (_context, done) {
      let server: http.Server = createServer({ secret: 'awesome cat' }, function (req: TestRequest, res: TestResponse) {
        if (!req.session.user) {
          req.session.user = 'bob';
          res.end('set');
        } else {
    ...
    it('should sign and unsign with a Buffer', function (_context, done) {
      let server: http.Server = createServer(
    ...
    describe('when an array', function () {
      it('should sign cookies', function (_context, done) {
        let server: http.Server = createServer(
      ...
      it('should sign cookies with first element', function (_context, done) {
        let store = new session.MemoryStore();
      ...
      it('should read cookies using all elements', function (_context, done) {
        let store = new session.MemoryStore();
  ...
  describe('unset option', function () {
    ...
    it('should default to keep', function (_context, done) {
      let store = new session.MemoryStore();
      let server: http.Server = createServer({ store: store }, function (req: TestRequest, res: TestResponse) {
        req.session.count = req.session.count || 0;
        req.session.count++;
    ...
    it('should allow destroy on req.session = null', function (_context, done) {
      let store = new session.MemoryStore();
      let server: http.Server = createServer(
    ...
    it('should not set cookie if initial session destroyed', function (_context, done) {
      let store = new session.MemoryStore();
      let server: http.Server = createServer(
        { store: store, unset: 'destroy' },
        function (req: TestRequest, res: TestResponse) {
  ...
  describe('res.end patch', function () {
    it('should correctly handle res.end/res.write patched prior', function (_context, done) {
    ...
    it('should correctly handle res.end/res.write patched after', function (_context, done) {
      function respond(req: TestRequest, res: TestResponse) {
        utils.writePatch(res);
        req.session.hit = true;
        res.write('hello, ');
    ...
    it('should error when res.end is called twice', function (_context, done) {
      let error1 = null;
      let error2 = null;
  ...
  describe('req.session', function () {
    it('should persist', function (_context, done) {
      let store = new session.MemoryStore();
      let server: http.Server = createServer({ store: store }, function (req: TestRequest, res: TestResponse) {
        req.session.count = req.session.count || 0;
        req.session.count++;
    ...
    it('should only set-cookie when modified', function (_context, done) {
      let modify = true;
      let server: http.Server = createServer(null, function (req: TestRequest, res: TestResponse) {
        if (modify) {
          req.session.count = req.session.count || 0;
    ...
    it('should not have enumerable methods', function (_context, done) {
      let server: http.Server = createServer(null, function (req: TestRequest, res: TestResponse) {
        req.session.foo = 'foo';
        req.session.bar = 'bar';
        let keys = [];
    ...
    it('should not be set if store is disconnected', function (_context, done) {
      let store = new session.MemoryStore();
      let server: http.Server = createServer({ store: store }, function (req: TestRequest, res: TestResponse) {
    ...
    it('should be set when store reconnects', function (_context, done) {
      let store = new session.MemoryStore();
      let server: http.Server = createServer({ store: store }, function (req: TestRequest, res: TestResponse) {
        res.end(typeof req.session);
      });
    ...
    describe('.destroy()', function () {
      it('should destroy the previous session', function (_context, done) {
        let server: http.Server = createServer(null, function (req: TestRequest, res: TestResponse) {
    ...
    describe('.regenerate()', function () {
      it('should destroy/replace the previous session', function (_context, done) {
        let server: http.Server = createServer(null, function (req: TestRequest, res: TestResponse) {
    ...
    describe('.reload()', function () {
      it('should reload session from store', function (_context, done) {
        let server: http.Server = createServer(null, function (req: TestRequest, res: TestResponse) {
          if (req.url === '/') {
            req.session.active = true;
      ...
      it('should error is session missing', function (_context, done) {
        let store = new session.MemoryStore();
        let server: http.Server = createServer({ store: store }, function (req: TestRequest, res: TestResponse) {
          if (req.url === '/') {
            req.session.active = true;
      ...
      it('should not override an overridden `reload` in case of errors', function (_context, done) {
        let store = new session.MemoryStore();
        let server: http.Server = createServer(
          { store: store, resave: false },
          function (req: TestRequest, res: TestResponse) {
    ...
    describe('.save()', function () {
      it('should save session to store', function (_context, done) {
        let store = new session.MemoryStore();
        let server: http.Server = createServer({ store: store }, function (req: TestRequest, res: TestResponse) {
          req.session.hit = true;
      ...
      it('should prevent end-of-request save', function (_context, done) {
        let store = new session.MemoryStore();
        let server: http.Server = createServer({ store: store }, function (req: TestRequest, res: TestResponse) {
          req.session.hit = true;
          req.session.save(function (err) {
      ...
      it('should prevent end-of-request save on reloaded session', function (_context, done) {
        let store = new session.MemoryStore();
        let server: http.Server = createServer({ store: store }, function (req: TestRequest, res: TestResponse) {
          req.session.hit = true;
    ...
    describe('.touch()', function () {
      it('should reset session expiration', function (_context, done) {
        let store = new session.MemoryStore();
        let server: http.Server = createServer(
    ...
    describe('.cookie', function () {
      describe('.*', function () {
        it('should serialize as parameters', function (_context, done) {
        ...
        it('should default to a browser-session length cookie', function (_context, done) {
        ...
        it('should Set-Cookie only once for browser-session cookies', function (_context, done) {
          let server: http.Server = createServer({
            cookie: { path: '/admin' },
          });
        ...
        it('should override defaults', function (_context, done) {
          let opts = {
            httpOnly: false,
            maxAge: 5000,
            path: '/admin',
        ...
        it('should preserve cookies set before writeHead is called', function (_context, done) {
          let server: http.Server = createServer(null, function (req: TestRequest, res: TestResponse) {
        ...
        it('should preserve cookies set in writeHead', function (_context, done) {
          let server: http.Server = createServer(null, function (req: TestRequest, res: TestResponse) {
            let cookie = new Cookie();
            res.writeHead(200, {
      ...
      describe('.originalMaxAge', function () {
        it('should equal original maxAge', function (_context, done) {
          let server: http.Server = createServer(
            { cookie: { maxAge: 2000 } },
            function (req: TestRequest, res: TestResponse) {
        ...
        it('should equal original maxAge for all requests', function (_context, done) {
          let server: http.Server = createServer(
            { cookie: { maxAge: 2000 } },
            function (req: TestRequest, res: TestResponse) {
              res.end(JSON.stringify(req.session.cookie.originalMaxAge));
      ...
      describe('.secure', function () {
        ...
        it('should set cookie when secure', function (_context, done) {
      ...
      describe('.maxAge', function () {
        ...
        it('should set cookie expires relative to maxAge', function (_context, done) {
          request(suiteState.server)
            .get('/')
        ...
        it('should modify cookie expires when changed', function (_context, done) {
          request(suiteState.server)
            .get('/')
            .set('Cookie', suiteState.cookie)
        ...
        it('should modify cookie expires when changed to large value', function (_context, done) {
          request(suiteState.server)
            .get('/')
            .set('Cookie', suiteState.cookie)
      ...
      describe('.expires', function () {
        describe('when given a Date', function () {
          it('should set absolute', function (_context, done) {
            let server: http.Server = createServer(null, function (req: TestRequest, res: TestResponse) {
        ...
        describe('when null', function () {
          it('should be a browser-session cookie', function (_context, done) {
            let server: http.Server = createServer(null, function (req: TestRequest, res: TestResponse) {
          ...
          it('should not reset cookie', function (_context, done) {
            let server: http.Server = createServer(null, function (req: TestRequest, res: TestResponse) {
              req.session.cookie.expires = null;
              res.end();
            });
          ...
          it('should not reset cookie when modified', function (_context, done) {
            let server: http.Server = createServer(null, function (req: TestRequest, res: TestResponse) {
              req.session.cookie.expires = null;
      ...
      describe('.partitioned', function () {
        describe('by default', function () {
          it('should not set partitioned attribute', function (_context, done) {
            let server: http.Server = createServer();
        ...
        describe('when "true"', function () {
          it('should set partitioned attribute', function (_context, done) {
            let server: http.Server = createServer({
  ...
  describe('synchronous store', function () {
    it('should respond correctly on save', function (_context, done) {
    ...
    it('should respond correctly on destroy', function (_context, done) {
      let store = new SyncStore();
      let server: http.Server = createServer(
        { store: store, unset: 'destroy' },
        function (req: TestRequest, res: TestResponse) {
  ...
  describe('cookieParser()', function () {
    it('should ignore req.cookies when the header has no session cookie', function (_context, done) {
    ...
    it('should reject unsigned from req.cookies', function (_context, done) {
      let app: Handler = express()
        .use(cookieParser())
        .use(function (req: TestRequest, res: TestResponse, next) {
          req.headers.cookie = 'foo=bar';
    ...
    it('should reject invalid signature from req.cookies', function (_context, done) {
      let app: Handler = express()
        .use(cookieParser())
        .use(function (req: TestRequest, res: TestResponse, next) {
          req.headers.cookie = 'foo=bar';
    ...
    it('should ignore req.signedCookies when the header has no session cookie', function (_context, done) {
      let app: Handler = express()
